...
const __default__ = {
  ...
  methods: {
    ...
    async loadPotensiCategory() {
      ...
      const data = await $fetch(this.$config.public.API_PUBLIC_URL + "/api/potensi-category");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_dialog, {
        modelValue: _ctx.modalRemovePotensi,
        "onUpdate:modelValue": ($event) => _ctx.modalRemovePotensi = $event,
        width: "auto"
      }, {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_card, {
              ...
              text: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div${_scopeId2}><span${_scopeId2}>Potensi Desa yang dihapus tidak bisa dikembalikan kembali.</span></div>`);
                } else {
                  return [
                    createVNode("div", null, [
                      createVNode("span", null, "Potensi Desa yang dihapus tidak bisa dikembalikan kembali.")
                    ])
                  ];
                }
              }),
      ...
      _push(`<div class="flex justify-between items-center mb-3"><div class="text-2xl font-semibold mb-2">Potensi Desa</div><div class="text-md font-semibold mb-2">`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/dashboard/potensi-desa/add" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_btn, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="capitalize"${_scopeId2}>Tambah Potensi Desa +</span>`);
                } else {
                  return [
                    createVNode("span", { class: "capitalize" }, "Tambah Potensi Desa +")
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode("div", { class: "flex justify-center" }, [
                ...
                ("useParseJWT" in _ctx ? _ctx.useParseJWT : unref(useParseJWT))().value.is_admin == 1 || ("useParseJWT" in _ctx ? _ctx.useParseJWT : unref(useParseJWT))().value.user == item.user_id ? (openBlock(), createBlock("div", {
                  key: 0,
                  onClick: ($event) => _ctx.$router.push("/dashboard/potensi-desa/edit?id=" + item.uuid),
                ...
                ("useParseJWT" in _ctx ? _ctx.useParseJWT : unref(useParseJWT))().value.is_admin == 1 || ("useParseJWT" in _ctx ? _ctx.useParseJWT : unref(useParseJWT))().value.user == item.user_id ? (openBlock(), createBlock("div", {
                  key: 1,
                  class: "cursor-pointer",
                  onClick: ($event) => _ctx.openModalRemovePotensi(item.uuid)
                }, [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
                    width: "1.5em",
      ...
      _push(`</div></div></div><div class="flex justify-between items-center mb-3"><div class="text-2xl font-semibold mb-2">Kategori Potensi Desa</div><div class="text-md font-semibold mb-2">`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/dashboard/potensi-desa/category/add" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_btn, {
              onClick: _ctx.updateContent,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Dashboard/Potensi-Desa/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-3feeabf2.mjs.map
