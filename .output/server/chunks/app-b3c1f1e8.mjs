        ...
        _push(ssrRenderComponent(_component_v_list, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(ssrRenderComponent(_component_v_list_group, null, {
                activator: withCtx(({ props }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_v_list_item, mergeProps(props, { title: "Profil Desa" }), null, _parent3, _scopeId2));
                  } else {
                    return [
                      createVNode(_component_v_list_item, mergeProps(props, { title: "Profil Desa" }), null, 16)
                    ];
                  }
                }),
              ...
              _push2(ssrRenderComponent(_component_v_list_group, null, {
                activator: withCtx(({ props }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_v_list_item, mergeProps(props, { title: "Pemerintahan" }), null, _parent3, _scopeId2));
                  } else {
                    return [
                      createVNode(_component_v_list_item, mergeProps(props, { title: "Pemerintahan" }), null, 16)
                    ];
                  }
                }),
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              ...
              _push2(ssrRenderComponent(_component_v_list_group, null, {
                activator: withCtx(({ props }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_v_list_item, mergeProps(props, { title: "Informasi Publik" }), null, _parent3, _scopeId2));
                  } else {
                    return [
                      createVNode(_component_v_list_item, mergeProps(props, { title: "Informasi Publik" }), null, 16)
                    ];
                  }
                }),
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              ...
              return [
                ...
                createVNode(_component_v_list_group, null, {
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex-none" }, _attrs))} data-v-28756a9a><div class="grid text-sm sm:text-base grid-cols-1 md:grid-cols-3 gap-x-[6rem] gap-y-8 px-[2rem] sm:px-[6rem] md:px-[3rem] lg:px-[10rem] xl:px-[14rem] bg-[#0088CC] text-white py-8" data-v-28756a9a><div class="block" data-v-28756a9a><div class="text-xl md:text-2xl font-semibold" data-v-28756a9a><span data-v-28756a9a>Profil</span></div><div class="mt-3 leading-6" data-v-28756a9a><span data-v-28756a9a>${ssrInterpolate(unref(data).profile)}</span></div></div><div class="block" data-v-28756a9a><div class="text-xl md:text-2xl font-semibold" data-v-28756a9a><span data-v-28756a9a>Sosial Media</span></div><div class="text-sm mt-3" data-v-28756a9a><ul data-v-28756a9a><!--[-->`);
      ssrRenderList(unref(socialMedia), (item) => {
        _push(`<li class="flex items-center" data-v-28756a9a>`);
        ...
        _push(`<a class="ml-1 text-white" target="_blank"${ssrRenderAttr("href", item.link)} data-v-28756a9a>${ssrInterpolate(item.name)}</a></li>`);
      });
      _push(`<!--]--></ul></div></div><div class="block" data-v-28756a9a><div class="text-xl md:text-2xl font-semibold" data-v-28756a9a><span data-v-28756a9a>Alamat Lengkap</span></div><div class="mt-3" data-v-28756a9a><span data-v-28756a9a>${ssrInterpolate(unref(data).address)}</span></div></div></div><div class="bg-[#0077B3] px-[2rem] sm:px-[6rem] md:px-[3rem] lg:px-[10rem] xl:px-[14rem] text-white py-5" data-v-28756a9a><p class="text-base" data-v-28756a9a>${ssrInterpolate(unref(data).copyright)}</p></div></div>`);
    };
  }
};
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-28756a9a"]]);
...
//# sourceMappingURL=app-b3c1f1e8.mjs.map
