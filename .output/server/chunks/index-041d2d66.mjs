...
const _sfc_main$4 = {
  ...
  async setup(__props) {
    ...
    announcement.value = ([__temp, __restore] = withAsyncContext(() => $fetch("/api/pengumuman?limit=5")), __temp = await __temp, __restore(), __temp).data;
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    ...
    ref(null);
    images.value = ([__temp, __restore] = withAsyncContext(() => $fetch("/api/image-gallery?limit=6")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_v_img = resolveComponent("v-img");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "block col-span-4" }, _attrs))} data-v-add6309e><div class="text-[#0088CC] border-[#0088CC] border-b-2 mb-6 text-xl md:text-2xl font-semibold py-3" data-v-add6309e><span data-v-add6309e>Galeri Desa</span></div><div id="gallery" class="rounded-lg grid grid-cols-1 md:grid-cols-3 mb-2 gap-6" data-v-add6309e><!--[-->`);
      ssrRenderList(unref(images), (image, key) => {
        _push(`<a class="rounded-lg h-full w-full relative"${ssrRenderAttr("href", image.url)} data-pswp-width="600" data-pswp-height="400" target="_blank" rel="noreferrer" data-v-add6309e>`);
        _push(ssrRenderComponent(_component_v_img, {
          "lazy-src": image.url,
          class: "rounded-md",
          cover: "",
        ...
        _push(`<div class="rounded-b-lg z-10 py-1 backdrop-blur-xl opacity-90 pl-2 bg-[#0088CC] bottom-0 absolute w-full text-white" data-v-add6309e><p class="truncate text-sm md:text-base" data-v-add6309e>${ssrInterpolate(image.description)}</p></div></a>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-add6309e"]]);
const _sfc_main$1 = {
  __name: "Location",
  __ssrInlineRender: true,
  async setup(__props) {
                  ...
                  if (_push3) {
                    ...
                    return [
                      createVNode("div", {
                        ...
                        createVNode("div", { class: "rounded-md px-5 absolute bottom-8 description left-[50%] md:left-[10rem] bg-black/40 w-fit text-center text-white text-base md:text-xl" }, [
              ...
              _push2(ssrRenderComponent(unref(SwiperSlide), { class: "relative rounded-lg" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<div class="text-sm sm:text-lg font-normal rounded-b-md z-10 py-1 backdrop-blur-xl opacity-90 pl-2 bg-[#0088CC] bottom-0 absolute w-full text-white"${_scopeId2}><span${_scopeId2}>${ssrInterpolate(item.name)} - ${ssrInterpolate(item.job)}</span></div>`);
                  } else {
                    return [
                      ...
                      createVNode("div", { class: "text-sm sm:text-lg font-normal rounded-b-md z-10 py-1 backdrop-blur-xl opacity-90 pl-2 bg-[#0088CC] bottom-0 absolute w-full text-white" }, [
...
//# sourceMappingURL=index-041d2d66.mjs.map
