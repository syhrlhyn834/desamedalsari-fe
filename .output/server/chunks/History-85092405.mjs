...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="text-2xl font-semibold mb-2">Sejarah Desa</div><div class="grid animate-fade"><div class="col-12"><div class="card"><h3 class="mb-3 text-xl font-medium">Konten</h3>`);
...
//# sourceMappingURL=History-85092405.mjs.map
