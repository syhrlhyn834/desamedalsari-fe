import { ref, computed, resolveComponent, mergeProps, withCtx, createVNode, unref, openBlock, createBlock, toDisplayString, useSSRContext } from 'vue';
import { b as useRouter$1, n as navigateTo, a as useToken } from './server.mjs';
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "block rounded-lg cursor-pointer mt-2 bg-white border border-slate-200 pt-2" }, [
                createVNode("div", {
                  onClick: ($event) => ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))("/dashboard/profile"),
      ...
      _push(ssrRenderComponent(_component_v_menu, { "open-on-hover": "" }, {
        activator: withCtx(({ props }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createVNode("button", mergeProps(props, { class: "p-link layout-topbar-button" }), [
...
//# sourceMappingURL=AppTopbar-b1ef8d69.mjs.map
