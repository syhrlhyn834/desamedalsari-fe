...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    potensiCategory.value = ([__temp, __restore] = withAsyncContext(() => $fetch("/api/potensi-category?limit=5&allow_empty=1")), __temp = await __temp, __restore(), __temp);
...
//# sourceMappingURL=LatestPotensi-8c1dbcef.mjs.map
